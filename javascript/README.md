...
**Current code checkpoint — `21678de`:** B-spline/NURBS surface evaluation and polygon-mesh sampling, conversion, retained records and clone semantics are implemented. Local verification passes 2,635 original JavaScript cases, 459 supplemental tests, 1,066 surface scenarios / 17,258 operations and 6,316 entity scenarios / 36,735 operations in both configurations. Real Chromium executes all 123,141 inline comparisons per configuration; the prior UCS/Bézier NaN-sign failures remain blocking. The ledger is 239/510 library mirrors, 47/193 conformance-file mirrors and 2,635/35,309 original cases. [Current contracts, evidence and remaining failures](doc/POLYGON_MESH_SURFACES.md).
