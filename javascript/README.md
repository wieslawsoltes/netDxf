...
**Current code checkpoint — `6fed62c`:** all recovered exp/log work and the new HELIX model/test integration are committed and pushed. HELIX preserves analytic parameters separately from its stored spline and supports bounded cubic authoring, evaluation, regeneration and staged similarity transforms. Local and hosted Linux verification pass 2,634 original cases, 431 supplemental tests, 6,058 entity scenarios / 34,745 operations, and all 13,512 new exact exp/log comparisons in Debug and Release. The full port is still incomplete: 232/510 library mirrors, 46/193 conformance-file mirrors, and 2,634/35,309 original cases. [Current contracts, evidence and remaining failures](doc/HELIX.md).
