...
export class DiametricDimension extends Dimension {
  ...
  static $create0(...args) { return new DiametricDimension(ConstructorTag, 0, args); }
  $ctor1(arc, rotation) {
    this.$ctor2(arc, rotation, DimensionStyle.Default);
  }
  static $create1(...args) { return new DiametricDimension(ConstructorTag, 1, args); }
  ...
  static $create2(...args) { return new DiametricDimension(ConstructorTag, 2, args); }
  $ctor3(circle, rotation) {
    this.$ctor4(circle, rotation, DimensionStyle.Default);
  }
  static $create3(...args) { return new DiametricDimension(ConstructorTag, 3, args); }
  ...
  static $create4(...args) { return new DiametricDimension(ConstructorTag, 4, args); }
  $ctor5(centerPoint, referencePoint) {
    this.$ctor6(centerPoint, referencePoint, DimensionStyle.Default);
  }
  static $create5(...args) { return new DiametricDimension(ConstructorTag, 5, args); }
  ...
  static $create6(...args) { return new DiametricDimension(ConstructorTag, 6, args); }
  static CreateOverload(signature, ...args) {
    if (signature === "") { if (!(args.length === 0)) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create0(...args); }
    if (signature === "netDxf.Entities.Arc,double") { if (!(args.length === 2 && (args[0] === null || args[0] instanceof Arc) && (typeof args[1] === 'number'))) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create1(...args); }
    if (signature === "netDxf.Entities.Arc,double,netDxf.Tables.DimensionStyle") { if (!(args.length === 3 && (args[0] === null || args[0] instanceof Arc) && (typeof args[1] === 'number') && (args[2] === null || args[2] instanceof DimensionStyle))) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create2(...args); }
    if (signature === "netDxf.Entities.Circle,double") { if (!(args.length === 2 && (args[0] === null || args[0] instanceof Circle) && (typeof args[1] === 'number'))) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create3(...args); }
    if (signature === "netDxf.Entities.Circle,double,netDxf.Tables.DimensionStyle") { if (!(args.length === 3 && (args[0] === null || args[0] instanceof Circle) && (typeof args[1] === 'number') && (args[2] === null || args[2] instanceof DimensionStyle))) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create4(...args); }
    if (signature === "netDxf.Vector2,netDxf.Vector2") { if (!(args.length === 2 && (args[0] instanceof Vector2) && (args[1] instanceof Vector2))) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create5(...args); }
    if (signature === "netDxf.Vector2,netDxf.Vector2,netDxf.Tables.DimensionStyle") { if (!(args.length === 3 && (args[0] instanceof Vector2) && (args[1] instanceof Vector2) && (args[2] === null || args[2] instanceof DimensionStyle))) throw new ArgumentException('Arguments do not match the selected constructor.'); return DiametricDimension.$create6(...args); }
  ...
  get Measurement() {
    return (2 * Vector2.Distance(this.$center, this.$refPoint));
  }
  ...
  CalculateReferencePoints() {
    ...
    let centerRef = Copy(this.$center);
    let ref1 = Copy(this.$refPoint);
