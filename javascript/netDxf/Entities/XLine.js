...
export class XLine extends EntityObject {
  #origin; #direction;
  constructor(...args){
    super(EntityType.XLine,DxfObjectCode.XLine);
  ...
  Clone(){const copy=this.$copyEntityAttributes(new XLine());copy.Origin=this.#origin;copy.Direction=this.#direction;return this.$finishEntityClone(copy);}
}
