...
export class PolygonMeshRecord extends DxfObject {
  ...
  CommonEnd=0;XDataStart;Position=Vector3.Zero;SourceDocument=null;
  ...
  CopyForClone(){
    const copy=new PolygonMeshRecord(this.CodeName,new ReferenceList(this.Tags));
    for(const k of ['SourceOwner','CommonEnd','XDataStart','Position','IdentityIndex','OwnerIndex','ExtensionHandle','UsesBlockRecordOwner','SourceVersion'])copy[k]=Copy(this[k]);
