...
export class Solid extends EntityObject {
  #vertices; Elevation=0; Thickness=0;
  constructor(...args){
    super(EntityType.Solid,DxfObjectCode.Solid);
    ...
    }else throw new ArgumentException('No matching Solid constructor.');
  }
  ...
  Clone(){
    const copy=this.$copyEntityAttributes(new Solid());copy.#vertices=this.#vertices.map(Copy);copy.Thickness=this.Thickness;
