...
const methods = {
  ValidateStoredTableEntityAdoption(entity){
    ...
    if(entity instanceof api.DxfOpaqueEntity)entity.ValidateIncoming(this);
    ...
    if(!(entity instanceof api.DxfOpaqueEntity)&&!simpleEntities.has(entity.CodeName)&&!['DIMENSION','ARC_DIMENSION','LEADER','TOLERANCE','INSERT','SHAPE','TEXT','MTEXT','IMAGE','MLINE','DGNUNDERLAY','DWFUNDERLAY','PDFUNDERLAY','VIEWPORT','MULTILEADER','SECTION','SECTIONOBJECT','ACAD_TABLE'].includes(entity.CodeName))
  ...
  ValidateStoredTableBlockAdoption(root){
    ...
    const visit=block=>{
      ...
      for(const entity of block.Entities){
        if(entity instanceof api.DxfOpaqueEntity)entity.ValidateIncoming(this,block);
