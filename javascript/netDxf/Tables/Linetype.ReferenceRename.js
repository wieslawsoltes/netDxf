...
export function InstallLinetypeReferenceRename(Type) {
  Type.prototype.OnNameChangedEvent = function(oldName, newName) {
    if (NativeString.IsNullOrWhiteSpace(newName)) throw new ArgumentException('A Linetype name cannot be blank.', 'newName');
