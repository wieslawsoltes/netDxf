...
try {
  ...
  for(const [category,probes] of [['output-settings',outputSettingsCorpus()],['groups',groupCorpus()],['surfaces',surfaceCorpus()],['hatch',hatches],['styles',styles],['entities',entityCorpus()],['coordinates',coordinateCorpus()],['database-models',databaseModelCorpus()]])for(const probe of probes){
