...
try {
  ...
  for(const [category,probes] of [['mlines',mlineCorpus()],['output-settings',outputSettingsCorpus()],['groups',groupCorpus()],['surfaces',surfaceCorpus()],['hatch',hatches],['styles',styles],['entities',entityCorpus()],['coordinates',coordinateCorpus()],['database-models',databaseModelCorpus()]])for(const probe of probes){
