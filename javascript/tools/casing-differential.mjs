...
let completed=false, fatal=null, failures=0;
...
try {
  ...
  fs.writeFileSync(path.join(out,'results.json'),JSON.stringify({...proof,sourceRef:baseline.ref,configuration,completed,fatal,stats:{comparisons:pairs.length,failures}},null,2)+'\n');
}
