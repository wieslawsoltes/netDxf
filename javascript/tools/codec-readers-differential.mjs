...
try{
  ...
  if(corpus.length!==913||new Set(corpus.map(p=>p.name)).size!==913||corpus.reduce((sum,p)=>sum+p.request.steps.length,0)!==27962)throw new Error('Incomplete or duplicate codec corpus.');
  ...
  if(report.stats.commands!==27407||report.stats.constructorRejections!==35)throw new Error('Native execution cardinality changed; original observations retained.');
