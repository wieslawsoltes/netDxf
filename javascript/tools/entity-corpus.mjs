...
export function entityCorpus() {
 ...
 return probes.concat(sectionCorpus(),oleCorpus(),acisCorpus(),displayEntityCorpus(),mtextCorpus(),underlayCorpus(),rasterCorpus(),polyfaceCorpus(),lightCorpus(),curveCorpus());
}
