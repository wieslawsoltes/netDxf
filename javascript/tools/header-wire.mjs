...
import { HeaderVariables,HeaderVariable,HeaderDateTime,HeaderTimeSpan,HeaderEnum } from '../index.js';
import { BoxedScalar } from '../runtime/BoxedScalar.js';
function typeName(value){
  if(value==null)return null;
  if(value instanceof BoxedScalar||value instanceof HeaderEnum)return value.Type;
...
export function headerWire(value,wire){
  ...
  if(value instanceof BoxedScalar||value instanceof HeaderEnum)return wire(value.Value);
