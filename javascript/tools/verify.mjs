...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':479,'stats.operations':2598}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:100444}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:100444}}],
};
