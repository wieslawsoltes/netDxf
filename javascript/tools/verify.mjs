...
guard('generated',()=>{
  ...
  const gte=read('gte-port-manifest.json');
  assert(gte.sourceRef===baseline.ref&&gte.files.length===17,'Incomplete/unpinned GTE lowering.');
  native.files.push(...gte.files);
...
const specs={
  environmentIO:[`environment-io/${configuration}`,{equal:{'stats.scenarios':1760,'stats.observedScenarios':1760,'stats.requestedOperations':10173,'stats.operations':10173,'stats.oracleFailures':0}}],
  environmentBrowser:[`environment-browser/${configuration}`,{equal:{comparisons:1760,scope:'environment-io-only',fullSuite:false}}],
  ...
  transportSections:[`transport-sections/${configuration}`,{equal:{'stats.scenarios':1165,'stats.observedScenarios':1165,'stats.requestedOperations':3473,'stats.operations':3473,'stats.oracleFailures':0}}],
  gte:[`gte/${configuration}`,{equal:{'stats.scenarios':401,'stats.observedScenarios':401,'stats.requestedOperations':5435,'stats.operations':5435,'stats.oracleFailures':0}}],
  codecReaders:[`codec-readers/${configuration}`,{equal:{'stats.scenarios':913,'stats.requestedCommands':27962,'stats.commands':27407,'stats.constructorRejections':35}}],
  codecWriters:[`codec-writers/${configuration}`,{equal:{'stats.scenarios':509,'stats.requestedCommands':5527,'stats.commands':5495,'stats.constructorRejections':5}}],
  storedDependencies:[`stored-dependencies/${configuration}`,{equal:{'stats.scenarios':738,'stats.observedScenarios':738,'stats.requestedOperations':5566,'stats.operations':5566,'stats.oracleFailures':0}}],
  tableContent:[`table-content/${configuration}`,{equal:{'stats.scenarios':284,'stats.observedScenarios':284,'stats.requestedOperations':4850,'stats.operations':4850,'stats.oracleFailures':0}}],
  storedTables:[`stored-table/${configuration}`,{equal:{'stats.scenarios':139,'stats.observedScenarios':139,'stats.requestedOperations':1679,'stats.operations':1679,'stats.oracleFailures':0}}],
  tableGeometry:[`table-geometry/${configuration}`,{equal:{'stats.scenarios':270,'stats.observedScenarios':270,'stats.requestedOperations':3966,'stats.operations':3966,'stats.oracleFailures':0}}],
  tableStyles:[`table-style/${configuration}`,{equal:{'stats.scenarios':279,'stats.observedScenarios':279,'stats.requestedOperations':5829,'stats.operations':5829,'stats.oracleFailures':0}}],
  sectionManager:[`section-manager/${configuration}`,{equal:{'stats.scenarios':174,'stats.observedScenarios':174,'stats.requestedOperations':5406,'stats.operations':5406,'stats.oracleFailures':0}}],
  ...
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:156657}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:156657}}],
};
