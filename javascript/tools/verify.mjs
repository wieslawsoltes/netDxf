...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':4235,'stats.operations':24335}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:105049}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:105049}}],
};
