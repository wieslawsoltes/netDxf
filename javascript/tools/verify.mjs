...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':1017,'stats.operations':6257}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:100982}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:100982}}],
};
