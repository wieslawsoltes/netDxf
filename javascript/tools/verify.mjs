...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':6058,'stats.operations':34745}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:121817}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:121817}}],
};
