...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':6316,'stats.operations':36735}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:123141}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:123141}}],
};
