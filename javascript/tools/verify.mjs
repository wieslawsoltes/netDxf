...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':2075,'stats.operations':14360}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:102040}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:102040}}],
};
