...
const specs={
  styles:[`style-differential/${configuration}`,{equal:{'stats.scenarios':528,'stats.operations':3559,'stats.textComparisons':112}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:7159}}],
};
