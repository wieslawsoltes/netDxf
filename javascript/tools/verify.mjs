...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':1565,'stats.operations':11957}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:101530}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:101530}}],
};
