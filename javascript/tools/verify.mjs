...
const specs={
  ...
  entities:[`entity-differential/${configuration}`,{equal:{'stats.scenarios':5762,'stats.operations':32504}}],
  browserInline:[`browser-inline/${configuration}`,{equal:{fixtures:399},minimum:{comparisons:108009}}],
  ...
  browser:['browser',{equal:{fixtures:399},minimum:{comparisons:108009}}],
};
