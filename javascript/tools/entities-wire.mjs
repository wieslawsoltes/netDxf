import { concreteDimensionWire } from './concrete-dimension-wire.mjs';
...
export function entityWire(value, wire) {
  ...
  const dimension=concreteDimensionWire(value,common,wire);if(dimension!==undefined)return dimension;
