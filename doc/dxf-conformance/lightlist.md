...
The 189 focused cases include 120 recognized malformed packets, 24 private-extension fallbacks, 16 independent-source round-trips, 8 authored graphs, 8 mapped clones, 8 class contracts, 4 older-profile checks and 1 authoring-validation scenario. Additional independent negative probes reject an altered stored name and a payload group5 that points at the LIGHTLIST object instead of its LIGHT. No native AutoCAD-created LIGHTLIST or native application behavior is part of these results.
