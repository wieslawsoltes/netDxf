...
namespace netDxf
{
    ...
    {
        private void RegisterStoredPolygonMeshRecords(PolygonMesh polyline)
        {
        ...
        private void UnregisterStoredPolygonMeshRecords(PolygonMesh polyline)
        {
            if (polyline == null) return;
            foreach (PolygonMeshRecord record in polyline.StoredRecords) this.AddedObjects.Remove(record.Handle);
        }
    }
}
